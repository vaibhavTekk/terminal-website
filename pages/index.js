...
export default function Home() {
  return (
    <div className="p-4 flex flex-col justify-center items-center h-screen">
      ...
      <HistoryProvider>
        <main className="flex flex-col-reverse font-['JetBrains_Mono'] w-[960px] bg-andromedabackground rounded-lg drop-shadow-[0_12px_12px_rgba(255,255,255,0.15)]">
          <div className="px-4 pb-4 h-[540px] overflow-y-auto mb-2 scroll-smooth">
            <History />
            <Input />
          </div>
